...
void Sprite::draw(MathLibrary::Matrix3 transform)
{
    ...
    MathLibrary::Vector2 pos = MathLibrary::Vector2(transform.m12, transform.m22);
    ...
    Color spriteColor = { color.x,color.y,color.z,color.w };
    
    //Draw the sprite
    RAYLIB_H::DrawTextureEx(*m_texture, rayPos,
        (float)(rotation * 180.0f / PI), 32, spriteColor);
